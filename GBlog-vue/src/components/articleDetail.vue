<template>
  <div class="detailBox tcommonBox">
    <span class="s-round-date">
      <span
        class="month"
        v-html="showInitDate(detailObj.createTime, 'month') + '-'"
      ></span>
      <span
        class="day"
    ...
    <header>
      ...
      <h2>
        <i class="fa fa-fw fa-user"></i> published
        <span>{{ detailObj.createTime }}</span> • <i class="fa fa-fw fa-eye"></i
        >{{ detailObj.viewCount }} views •
      </h2>
      <div class="ui label">
    ...
    <div class="donate">
      <div class="donate-word">
        <span @click="pdonate = !pdonate">Like</span>
      </div>
      <el-row
      ...
      >
        <el-col :span="12" class="donate-item">
          <div class="donate-tip">
            ...
            />
            <span>Tip me for this blog 😀</span>
          </div>
        </el-col>
        <!-- <el-col :span="12"  class="donate-item">
                        <div class="donate-tip">
...
export default {
  data() {
    return {
      aid: "", // Blog ID
      pdonate: true, // Open the tip control panel
      detailObj: {},
      haslogin: false,
      userId: "",
    };
