          ...
          <div class="headBox">
            ...
            >
              <el-menu-item index="/Home"
                ><i class="fa fa-wa fa-home"></i> Home</el-menu-item
              >
              <el-submenu index="/Share">
                <template slot="title"
                  ><i class="fa fa-wa fa-archive"></i> Category</template
                >
                <el-menu-item
              ...
              <el-menu-item index="/Reward"
                ><i class="fa fa-wa fa-cny"></i> Tip</el-menu-item
              >
              <el-menu-item index="/Friendslink"
                ><i class="fa fa-wa fa-users"></i>Link</el-menu-item
              >
...
export default {
  ...
  methods: {
    ...
    userlogout: function () {
      var that = this;
      this.$confirm("Sign out the App?", "Sign out Alert", {
  ...
  mounted() {
    ...
    var timer = setTimeout(function () {
      Typeit(that.$store.state.themeObj.user_start, "#luke"); // Typewritter effect
      clearTimeout(timer);
    }, 500);
  },
};
