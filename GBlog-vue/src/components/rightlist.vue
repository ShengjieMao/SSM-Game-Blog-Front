<template>
  <div class="rightlistBox">
    ...
    <section class="rs4">
      <h2 class="ui label">Hot Topics</h2>
      <ul>
...
export default {
  data() {
    return {
      ...
      artCommentList: "",
      catchMeObj: {
        Nintendo: "url_placeholder",
        Play Station: "url_placeholder",
        XBox: "url_placeholder",
        Steam: "url_placeholder",
        Reddit: "url_placeholder",
        Apple Game Center: "url_placeholder",
      },
    };
  },
  methods: {
